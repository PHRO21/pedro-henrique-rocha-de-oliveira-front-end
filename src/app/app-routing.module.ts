...
import { CriaLivroComponent } from './components/livro/cria-livro/cria-livro.component';
...
import { DeletaLivroComponent } from './components/livro/deleta-livro/deleta-livro.component';
...
const routes: Routes = [
  ...
  {
    path:"livros/deleta",
    component:DeletaLivroComponent
  }
];
